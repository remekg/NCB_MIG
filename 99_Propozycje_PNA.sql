...
--adres podstawowy
UPDATE en.Stg_PH
	SET KOD_POCZTOWY_POP = (SELECT PNA FROM ##tmp WHERE en.Stg_PH.TERYT_MIEJSCOWOSC = TERYT_MIEJ_SIMC)
WHERE 1=1
	AND CzyMIG > 0
--adres koresp
UPDATE en.Stg_PH
	SET KOR_KOD_POCZTOWY_POP = (SELECT PNA FROM ##tmp WHERE en.Stg_PH.KOR_TERYT_MIEJSCOWOSC = TERYT_MIEJ_SIMC)
WHERE 1=1
	AND CzyMIG > 0
	AND LEN(koresp) > 0
--adres PPE
UPDATE en.Stg_PPE
	SET [KOD_POCZTOWY_POP] = (SELECT PNA FROM ##tmp WHERE en.Stg_PPE.TERYT_MIEJSCOWOSC = TERYT_MIEJ_SIMC)
WHERE 1=1
	AND CzyMIG > 0
...
WHERE 1=1
	...
	AND en.Stg_PH.TERYT_MIEJSCOWOSC = ##tmp1.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.ULICE_CLR = ##tmp1.ULICE_TMP_CLR
	AND LEN(ULICE_CLR) > 0
--adres koresp
UPDATE en.Stg_PH
...
WHERE 1=1
	...
	AND en.Stg_PH.KOR_TERYT_MIEJSCOWOSC = ##tmp1.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.KOR_ULICE_CLR = ##tmp1.ULICE_TMP_CLR
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PPE.TERYT_MIEJSCOWOSC = ##tmp1.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PPE.ULICE_CLR = ##tmp1.ULICE_TMP_CLR
	AND LEN(ULICE_CLR) > 0
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.MIEJSCOWOSC_CLR = ##tmp2.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PH.ULICE_CLR = ##tmp2.ULICE_TMP_CLR
	AND LEN(ULICE_CLR) > 0
--adres koresp
UPDATE en.Stg_PH
	SET KOR_KOD_POCZTOWY_POP =PNA 
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOR_KOD_POCZTOWY_POP IS NULL OR LEN(KOR_KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.KOR_MIEJSCOWOSC_CLR = ##tmp2.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PH.KOR_ULICE_CLR = ##tmp2.ULICE_TMP_CLR
	AND LEN(KOR_ULICE_CLR) > 0
--adres PPE
UPDATE en.Stg_PPE
	SET KOD_POCZTOWY_POP =PNA 
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PPE.MIEJSCOWOSC_CLR = ##tmp2.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PPE.ULICE_CLR = ##tmp2.ULICE_TMP_CLR
	AND LEN(ULICE_CLR) > 0
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.TERYT_MIEJSCOWOSC = ##tmp3.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.ULICE_CLR = ##tmp3.ULICA_KROTKA_CLR
	AND LEN(ULICE_CLR) > 0
--ares koresp
UPDATE en.Stg_PH
	SET KOR_KOD_POCZTOWY_POP =PNA 
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOR_KOD_POCZTOWY_POP IS NULL OR LEN(KOR_KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.KOR_TERYT_MIEJSCOWOSC = ##tmp3.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.KOR_ULICE_CLR = ##tmp3.ULICA_KROTKA_CLR
	AND LEN(KOR_ULICE_CLR) > 0
--adres PPE
UPDATE en.Stg_PPE
	SET KOD_POCZTOWY_POP =PNA 
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PPE.TERYT_MIEJSCOWOSC = ##tmp3.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PPE.ULICE_CLR = ##tmp3.ULICA_KROTKA_CLR
	AND LEN(ULICE_CLR) > 0
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.MIEJSCOWOSC_CLR = ##tmp4.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PH.ULICE_CLR = ##tmp4.ULICA_KROTKA_CLR
	AND LEN(ULICE_CLR) > 0
--adres koresp
UPDATE en.Stg_PH
	SET KOR_KOD_POCZTOWY_POP = PNA  
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOR_KOD_POCZTOWY_POP IS NULL OR LEN(KOR_KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.KOR_MIEJSCOWOSC_CLR = ##tmp4.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PH.KOR_ULICE_CLR = ##tmp4.ULICA_KROTKA_CLR
	AND LEN(KOR_ULICE_CLR) > 0
--adres PPE
UPDATE en.Stg_PPE
	SET KOD_POCZTOWY_POP = PNA  
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PPE.MIEJSCOWOSC_CLR = ##tmp4.MIEJSCOWOSC_TMP_CLR
	AND en.Stg_PPE.ULICE_CLR = ##tmp4.ULICA_KROTKA_CLR
	AND LEN(ULICE_CLR) > 0
...
SELECT Klucz_PH AS Klucz_TMP_PH, (SELECT STRING_AGG(PNA,';') FROM ##tmp5 WHERE 
	...
	AND en.Stg_PH.TERYT_MIEJSCOWOSC = ##tmp5.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.ULICE_CLR = ##tmp5.ULICE_TMP_CLR
	AND LEN(ULICE_CLR) > 0
...
SELECT Klucz_PH AS Klucz_TMP_PH, (SELECT STRING_AGG(PNA,';') FROM ##tmp5 WHERE 
	...
	AND en.Stg_PH.KOR_TERYT_MIEJSCOWOSC = ##tmp5.TERYT_MIEJ_TMP_SIMC
	AND en.Stg_PH.KOR_ULICE_CLR = ##tmp5.ULICE_TMP_CLR
	AND LEN(KOR_ULICE_CLR) > 0
...
FROM ##tmp5b
WHERE en.Stg_PH.Klucz_PH = Klucz_TMP_PH
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.MIEJSCOWOSC_CLR = ##tmp6.MIEJSCOWOSC_TMP_CLR
--adres koresp
UPDATE en.Stg_PH
	SET KOR_KOD_POCZTOWY_POP = PNA  
FROM ##tmp6
WHERE 1=1
	AND CzyMIG > 0
	AND (KOR_KOD_POCZTOWY_POP IS NULL OR LEN(KOR_KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PH.KOR_MIEJSCOWOSC_CLR = ##tmp6.MIEJSCOWOSC_TMP_CLR
	AND LEN(koresp) > 0
--adres PPE
UPDATE en.Stg_PPE
	SET KOD_POCZTOWY_POP = PNA  
...
WHERE 1=1
	AND CzyMIG > 0
	AND (KOD_POCZTOWY_POP IS NULL OR LEN(KOD_POCZTOWY_POP) > LEN(PNA))
	AND en.Stg_PPE.MIEJSCOWOSC_CLR = ##tmp6.MIEJSCOWOSC_TMP_CLR
