/* **********************************************
Data : 01.08.2022
Obiekt biznesowy : Punkt poboru energii
Opis : wyszukiwanie terytów ulic

**************************************************/
USE NCB_MIG;

--Za³o¿enie indeksow
--DROP INDEX IF EXISTS  ix_ulice_01 ON [en].[Stg_PPE];
--CREATE INDEX ix_ulice_01 ON [en].[Stg_PPE] (TERYT_MIEJSCOWOSC, ulica)
