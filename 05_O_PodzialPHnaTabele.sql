...
(en_ob.PH_OSOBA, en_ob.PH_GRUPA, en_ob.PH_FIRMA oraz tworzy plik z relacjami en_ob.relacjegrupy)
*/

-- Osoby 
TRUNCATE TABLE en_ob.PH_OSOBA 

INSERT INTO en_ob.PH_OSOBA
(
...
--PLIK RELACJI
DROP TABLE IF EXISTS en_ob.relacjegrupy

SELECT O.[KEY], G.[KEY] AS KEY_1, O.[KEY] AS KEY_2
INTO en_ob.relacjegrupy
FROM en_ob.PH_GRUPA AS G
JOIN en_ob.PH_OSOBA AS O
ON G.[KEY] = O.BPEXT
